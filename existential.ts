...
//export function liftExt<F extends URIS4,A,B,C,E>(x : Kind4<F,A,B,C,E>) : <R>(cont : <X>(t : Kind4<F,A,B,C,X>) => R) => Existential4<F,A,B,C> 
//export function liftExt<F extends URIS3,A,B,E>(x : Kind3<F,A,B,E>) : <R>(cont : <X>(t : Kind3<F,A,B,X>) => R) => Existential3<F,A,B>
//export function liftExt<F extends URIS2,A,E>(x : Kind2<F,A,E>) : <R>(cont : <X>(t : Kind2<F,A,X>) => R) => Existential2<F,A> 
//export function liftExt<F extends URIS,E>(x : Kind<F,E>) : <R>(cont : <X>(t : Kind<F,X>) => R) => Existential<F> {
